...
1. Метакласс ClientVerifier реализован в файле metaclasses_and_descriptors.py, 
его наследует класс Client в файле client.py.
...
2. Реализовано в том же файле с теми же замечаниями. Фактически, используется тот же параметризованный код.